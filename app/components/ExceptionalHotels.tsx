            ...
            <div className="max-w-7xl mx-auto px-4 md:px-10">
                <div className="text-center mb-16">
                    ...
                    <h2 className="text-4xl md:text-6xl font-black text-(--gray-900) uppercase tracking-tighter leading-none">
                        EXCEPTIONAL <span className="text-transparent" style={{ WebkitTextStroke: '1.5px var(--gray-900)' }}>HOTELS</span>
                    </h2>
                </div>
                    ...
                    {hotels.map((hotel) => (
                        ...
                        >
                            <div className="relative h-64 overflow-hidden">
                                ...
                                {hotel.rating && (
                                    <div className="absolute top-4 right-4 bg-(--white)/95 backdrop-blur-md px-3 py-1 rounded-full flex items-center gap-1 shadow-xl">
                                        <icons.Star size={10} className="fill-(--brand-purple) text-(--brand-purple)" />
                                ...
                                <div className="absolute bottom-6 left-6">
                                    <p className="text-(--white) font-black text-xl group-hover:text-(--brand-teal) transition-colors">
                            ...
                            <div className="p-6 flex flex-col flex-1">
                                <div className="flex items-center gap-1.5 text-(--brand-purple) font-black text-[9px] uppercase tracking-widest mb-3">
                                ...
                                <div className="mt-auto flex items-center justify-between pt-4 border-t border-(--slate-50)">
                                    <span className="text-[10px] font-black uppercase tracking-widest text-(--brand-purple) flex items-center gap-2 group-hover:gap-3 transition-all">
