...
const FollowUs = () => {
    return (
        <section className="py-24 relative overflow-hidden bg-white">
            {/* Background Accent */}
            <div className="absolute top-0 right-0 w-1/3 h-full bg-[#5B2EFF]/5 skew-x-12 transform translate-x-32"></div>
            ...
            <div className="max-w-7xl mx-auto px-4 md:px-10 relative">
                <div className="flex flex-col lg:flex-row items-center gap-16">
                    ...
                    <div className="w-full lg:w-1/2 relative order-2 lg:order-1">
                        ...
                        {/* Decorative Circles */}
                        <div className="absolute -top-10 -left-10 w-40 h-40 bg-[#5EEAD4]/20 rounded-full blur-3xl"></div>
                    </div>
                    ...
                    <div className="w-full lg:w-1/2 order-1 lg:order-2">
                        ...
                        <h2 className="text-5xl md:text-7xl font-black text-gray-900 leading-[0.9] mb-8 italic uppercase tracking-tighter">
                            NEVER MISS <br />
                            <span className="text-[#5B2EFF]">THE BEST</span> <br />
                            TRAVEL DEALS!
                        </h2>
