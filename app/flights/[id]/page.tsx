                            ...
                            <div className="pt-8 border-t border-gray-100 flex flex-col md:flex-row items-center justify-between gap-6">
                                ...
                                {flight.link ? (
                                    <a
                                        ...
                                        className="px-12 py-4 bg-primary text-white font-bold rounded-2xl hover:bg-primary/90 hover:scale-[1.02] active:scale-[0.98] transition-all w-full md:w-auto flex items-center justify-center gap-2"
                                    >
                                        Book Now
