...
export default async function AdminDashboard() {
    ...
    const actions = [
        { label: 'Manage Hotels', href: '/admin/products', icon: icons.Package, color: 'bg-(--success)' },
        { label: 'Manage Flights', href: '/admin/flights', icon: icons.Plane, color: 'bg-(--primary)' },
        { label: 'Manage Rentals', href: '/admin/rentals', icon: icons.Car, color: 'bg-(--secondary)' },
    ];
